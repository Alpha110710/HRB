...
public class FragmentMyAddRateCouponOutData extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_my_add_rate_coupon_out_of_data, container, false);
    }

    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        pullToRefreshListView = (PullToRefreshListView) view.findViewById(R.id.list_add_rate_out_data);
    }
    ...
    private BizDataAsyncTask<List<MyAddRateCouponOutDateModel>> task;

    private void getMyAddRate(final boolean first, final boolean isPullDown) {

        task = new BizDataAsyncTask<List<MyAddRateCouponOutDateModel>>() {

            @Override
            protected void onExecuteSucceeded(List<MyAddRateCouponOutDateModel> result) {
            ...
            @Override
            protected List<MyAddRateCouponOutDateModel> doExecute() throws ZYException, BizFailure {
                if (isPullDown) {

                    return AccountBiz.getExpiredInterestRate("0", ExtraConfig.DEFAULT_PAGE_COUNT + "");
                } else {
                    if (isEnd) {
                        return new ArrayList<>();
                    } else {
                        return AccountBiz.getExpiredInterestRate(pageIndex + "", ExtraConfig.DEFAULT_PAGE_COUNT + "");
                    }
                }
            }
    ...
    class AddRateCouponUsedListAdapter extends BaseAdapter {
        ...
        private List<MyAddRateCouponOutDateModel> list = new ArrayList<MyAddRateCouponOutDateModel>();
        ...
        public void addItem(MyAddRateCouponOutDateModel cellOptions) {
        ...
        @Override
        public MyAddRateCouponOutDateModel getItem(int position) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            viewHolder.tv_item_add_rate_data.setText(list.get(position).getEND_DATE());
