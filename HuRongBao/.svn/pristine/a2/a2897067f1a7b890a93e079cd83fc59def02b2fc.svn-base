...
public class Util {
	 ...
	 * 
	 * @param float textSize The TextSize of the TextView
	 * @param String
	 *            content
	 * @return
	 */
    ...
    public static void gotoMain(Activity currentActiviy){
		...
		/*if(currentActiviy instanceof ActivityDebtBuy || currentActiviy instanceof ActivityInvestBuy){
			it.putExtra(ExtraConfig.IntentExtraKey.INVESTMENT_REFRESH, true);
		}*/
		currentActiviy.startActivity(it);	
	}
    
	public static void showLogin(Activity currentActiviy){
		Intent it = new Intent(currentActiviy,ActivityLogin.class);
