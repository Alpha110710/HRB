...
public class FragmentProjectDetail extends BaseFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        loan_data_web = (WebView) findViewById(R.id.loan_data_web);
    }
    ...
    private void getBorrowBaseInfo() {
        ...
        BizDataAsyncTask<List<GetBorrowBaseInfoModel>> getBorrowBaseInfo = new
                BizDataAsyncTask<List<GetBorrowBaseInfoModel>>(getWaitingView()) {
                    ...
                    protected List<GetBorrowBaseInfoModel> doExecute() throws ZYException, BizFailure {
                        return FinanceBiz.getBorrowBaseInfo(((ActivityInvestDetailMore) getActivity()).getBorrowId());
                    }

                    @Override
                    protected void onExecuteSucceeded(List<GetBorrowBaseInfoModel> getBorrowBaseInfoModel) {
                        if (getBorrowBaseInfoModel.get(0).getIMG_DESCRIPTION() == null) {
                            loan_data_web.loadDataWithBaseURL("", getBorrowBaseInfoModel.get(0).getDETAIL_DESCRIPTION(), "text/html", "utf-8", "");
                            getBorrowBaseInfoModel.remove(getBorrowBaseInfoModel.get(0));
    ...
    class MyadapterBottom extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            final MyViewHolder viewHodler;
            if (convertView == null) {
                viewHodler = new MyViewHolder();
                ...
                viewHodler = (MyViewHolder) convertView.getTag();
            }
