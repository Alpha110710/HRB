...
public class AutoTextView extends TextSwitcher implements
    ...
    //	private int[] imageTypes = {R.drawable.notice_type_system ,R.drawable.notice_type_huodong ,R.drawable.notice_type_tongzhi , R.drawable.notice_type_new} ;
    private int mType = 1;
    private TextView t;
...
//			img_off = res.getDrawable(imageTypes[mType-1]);
//			// 调用setCompoundDrawables时，必须调用Drawable.setBounds()方法,否则图片不显示
//			img_off.setBounds(0, 0, img_off.getMinimumWidth(),
//					img_off.getMinimumHeight());
//			t.setCompoundDrawables(img_off, null, null, null); // 设置左图标
