...
import com.hrb.utils.android.NetworkDetector;
import com.hrb.utils.java.Base64;
//import com.hrb.storage.PreferenceCache;
...
public class SoapProcessor {
	...
	public SoapProcessor(String wsClass, String method, boolean needToken){
		this(HuRongBaoConfig.WS_NAME_SPACE,HuRongBaoConfig.WS_BASE_URL + wsClass, method, needToken);
	}
	...
	public JsonElement request() throws BizFailure, ZYException {
		...
		if(!NetworkDetector.isNetworkAvailable(HuRongBaoApp.getAppContext())){
