...
public class ActivityTransferedDetail extends BaseActivity implements OnClickListener {

    private TextView tv_title;
    private ImageView iv_back;
    private MyTransferedModel.TRANSFERDETAILBean detailBean;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailBean = (MyTransferedModel.TRANSFERDETAILBean) getIntent().getParcelableExtra(ExtraConfig.IntentExtraKey.MY_TRANSFER_DETAIL_BEAN);
