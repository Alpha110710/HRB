...
public abstract class AbstractWheelView extends AbstractWheel {
     ...
     */
    @SuppressLint("NewApi") private void fadeSelectorWheel(long animationDuration) {
     ...
     * @param animationDuration The duration of the animation.
     */
    @SuppressLint("NewApi") private void lightSeparators(long animationDuration) {
